...
export default function VotingSection() {
  ...
  if (isLoading) {
    return (
      <section id="voting" className="py-8">
        <h2 className="section-title">Aktualne głosowania</h2>
  ...
  return (
    <section id="voting">
      ...
      <div className="space-y-6">
        {votings.length === 0 ? (
          <div className="text-center py-8">
            <p className="text-gray-600">Brak aktywnych głosowań</p>
          </div>
        ) : (
          votings.map((item) => (
      ...
      <div className="mt-8">
        <a href="/voting" className="btn-primary w-full text-center block">
